...
class _DashboardScreenState extends ConsumerState<DashboardScreen> {
  ...
  Future<void> _initializeDoseScheduling() async {
    try {
      // Skip heavy initialization during widget tests to allow pumpAndSettle to complete
  ...
  List<Schedule> _getTodaysSchedules(List<Schedule> schedules) {
    ...
    return schedules
        .where((schedule) => schedule.isActiveOnDate(today))
        .toList();
  }
          ...
          IconButton(
            ...
            onPressed: () {
              InfoSheet.show(
                ...
                title: 'Alerts',
                message:
                    'Summary of important items like missed doses. Detailed stock/expiry alerts are available in Supplies.',
              );
            },
          ),
          const SizedBox(width: 6),
            ...
            IconButton(
              ...
              onPressed: () {
                InfoSheet.show(
                  ...
                  title: 'Dashboard',
                  message:
                      'Overview of your medication activity and today\'s doses. Tap Take/Snooze to update your log.',
                );
              },
            ),
          ],
        ...
        DefaultTextStyle.merge(
          ...
          child: schedulesAsync.when(
            data: (schedules) {
              ...
              final todays =
                  _getTodaysSchedules(schedules).where((s) {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Padding(
      ...
      child: Row(
        children: [
          Icon(
            existingDoseLog?.status.name == 'taken'
                ? Icons.check_circle
                : Icons.schedule,
              ...
              child: Row(
                children: [
                  LabelChip(
                    ...
                    label: 'Low: ${status.lowStockCount}',
                    color: Colors.orange,
                  ),
                  LabelChip(
                    icon: Icons.error,
                    label: 'Expired: ${status.expiredCount}',
                    color: Colors.red,
                  ),
                  LabelChip(
                    icon: Icons.schedule,
                    label: 'Soon: ${status.expiringSoonCount}',
                    color: Colors.amber,
                  ),
                ],
              ),
          ...
          Row(
            ...
            children: [
              _buildActionButton(
                ...
                tooltip: 'Go to Medications list',
              ),
              _buildActionButton(
                context,
                Icons.add_circle,
              ...
              _buildActionButton(
                ...
                tooltip: 'Log a dose on your schedule',
              ),
              _buildActionButton(
                context,
                Icons.inventory_2,
        ...
        Wrap(
          ...
          children: [
            _buildActionButton(
              ...
              tooltip: 'Open Reconstitution Calculator',
            ),
            _buildActionButton(
              context,
              Icons.medication,
